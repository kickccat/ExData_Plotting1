...
# Plot4
png("plot4.png", width = 960, height = 800)
...
legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lty = c(1, 1, 1), lwd = c(2, 2, 2), bty = "n", cex = 1, y.intersp = 2, xjust = 0.5)
